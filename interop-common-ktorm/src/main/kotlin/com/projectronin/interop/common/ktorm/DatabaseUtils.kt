 ...
 */
fun <K : Any, T : Entity<T>> Database.singleValueLookup(lookupValue: K, column: Column<K>): T? {
 ...
 */
fun <K : Any, T : Entity<T>> Database.valueLookup(lookupValue: K, column: Column<K>): List<T> {
